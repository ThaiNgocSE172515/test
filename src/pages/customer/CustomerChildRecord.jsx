...
import { GetGrowthRecordsByChildIdAPI, DeleteGrowthRecordAPI } from '../../api/GrowthRecordAPI';
      ...
      <div className='mx-auto max-w-5xl rounded-lg bg-gray-50 px-6 py-6 shadow-md'>
        ...
        <div className='mt-4 overflow-x-auto'>
          <table className='w-full border border-gray-300 text-left text-sm text-gray-500'>
            ...
            <tbody>
              {records.map((record) => (
                <tr key={record.id} className='border-b border-gray-200 odd:bg-white even:bg-gray-50'>
                  <td className='px-4 py-3'>{record.createdAt.split('T')[0]}</td>
                  ...
                  <td className='flex items-center gap-2 px-4 py-3'>
                    <Link to={`/customer/editChildIndex/${childId}/${record.recordId}`}>
